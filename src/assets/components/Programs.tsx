  ...
  return (
    <div className="bg-secondary rounded-[30px] mx-4">
      <div className="py-8 px-4 mx-auto max-w-[1240px] lg:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-xl text-center mb-8 lg:mb-12 flex justify-center">
          <h1 className="px-4 pt-12 text-2xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl text-white uppercase w-full">
            Every Program is customized for each of you, but mostly it follows
            these categories:
          </h1>
        </div>
        <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0 ">
          <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-white  rounded-[15px] bg-[#252525] shadow  xl:p-8 ">
            <h3 className="mb-4 text-2xl font-semibold">Muscle Builder</h3>
            <p className="font-light text-gray-500 sm:text-lg ">
              Ideal for individuals looking to build muscle and improve
              strength.
            </p>
            ...
            <ul role="list" className="mb-8 space-y-4 text-left">
              ...
              <li className="flex items-center space-x-3">
                ...
                <span>Nutritional guidance included</span>
              </li>
              <li className="flex items-center space-x-3">
                <svg
                  className="flex-shrink-0 w-5 h-5 text-green-500 "
          ...
          <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-white  rounded-[15px] bg-[#252525]  shadow  xl:p-8 ">
            ...
            <ul role="list" className="mb-8 space-y-4 text-left">
              <li className="flex items-center space-x-3">
                ...
                <span>
                  Tailored cardiovascular exercises and heart-healthy nutrition
                </span>
              </li>
              <li className="flex items-center space-x-3">
                <svg
                ...
                <span>Monthly cardiovascular health assessments</span>
              </li>
              <li className="flex items-center space-x-3">
                <svg
                  className="flex-shrink-0 w-5 h-5 text-green-500 "
              ...
              <li className="flex items-center space-x-3">
                ...
                <span>Continuous support and detailed progress reports</span>
              </li>
              <li className="flex items-center space-x-3">
                <svg
                  className="flex-shrink-0 w-5 h-5 text-green-500 "
                ...
                <span>
                  Membership to a supportive online community and exclusive
                  resources
                </span>
              </li>
            </ul>
          ...
          <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-white  rounded-[15px] bg-[#252525] shadow  xl:p-8 ">
            <h3 className="mb-4 text-2xl font-semibold">Fat Burner</h3>
            <p className="font-light text-gray-500 sm:text-lg ">
              Ideal for individuals looking to lose fat and improve their
              overall health.
            </p>
            <div className="flex justify-center items-baseline my-8">
              <span className="mr-2 text-5xl font-extrabold">$29</span>
            ...
            <ul role="list" className="mb-8 space-y-4 text-left">
              <li className="flex items-center space-x-3">
                ...
                <span>Customized workout and diet plan</span>
              </li>
              <li className="flex items-center space-x-3">
                <svg
                  className="flex-shrink-0 w-5 h-5 text-green-500 "
                ...
                <span>Includes regular health and fitness check-ups</span>
              </li>
              <li className="flex items-center space-x-3">
                <svg
                  className="flex-shrink-0 w-5 h-5 text-green-500 "
