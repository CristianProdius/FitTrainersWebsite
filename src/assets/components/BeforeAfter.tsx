        ...
        <div className="grid gap-4">
          <div>
            <div className="h-auto max-w-full rounded-lg bg-[#383838] py-8 px-4">
              ...
              <Link
                to="/join"
                className=" text-background bg-gradient-to-r from-[#8dff96] to-main hover:text-main hover:from-background hover:to-black  font-medium rounded-[30px] text-l md:text-xl px-8 py-2 text-center whitespace-nowrap "
              >
                {t("Join Now")}
              </Link>
            </div>
        ...
        <div className="grid gap-4">
          ...
          <div>
            <div className="h-auto max-w-full rounded-lg bg-main py-8 px-4">
              ...
              <Link
                to="/join"
                className="text-background bg-white  hover:text-background hover:bg-gradient-to-r hover:from-[#8dff96] hover:to-main  font-medium rounded-[30px] text-l md:text-xl px-5 py-2.5 text-center mt-4 whitespace-nowrap "
              >
                {t("Join Now")}
              </Link>
            </div>
